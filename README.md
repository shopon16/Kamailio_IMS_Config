...
- Kamailio IMS + Open5gs (EPC) => Running in a OpenStack VM with internal IP 10.200.10.24 and Floating IP 172.24.15.30 (OpenStack is not mandatory, can run on a physical machine)
...
- Kamailio IMS => Running in a OpenStack VM with internal IP 10.200.10.24 and Floating IP 172.24.15.30 (OpenStack is not mandatory, can run on a physical machine)
